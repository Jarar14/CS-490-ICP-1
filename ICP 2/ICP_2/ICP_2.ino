...
#define SSID "6T"     // "SSID-WiFiname" 
#define PASS "123123123"       // "password"
#define IP "184.106.153.149"// thingspeak.com ip 184.106.153.149
String msg = "GET /update?key=ABCDEFGHIJKLMNOP"; //change it with your api key like "GET /update?key=Your Api Key"
